...
Based on what I see in this graph is that 2 3rds are in favor of capital punishment while 1 3rd are against it. Also what I can see here is that the White people have a big gap and the black and others have a smaller gap to where they have to share. What I think is that the information that is given in this graph isnt fair.
...
For the first and second one the numbers for the white race is more higher and fort the first one the black is higher tha nthe other. so in the second one the other is higher than the second one.  
...
In conclusion I think that the blacks and others shared and the whites had their own like example in the graph if you go and look at the favor you will see the difference between the oppose. Also as you can see there are different p values and that would tell you a difference. 
